...
install:
    go install ./cmd/k8s-pod-oom-oracle
    mise reshim 2>/dev/null || true
    @echo "installed → $(which k8s-pod-oom-oracle 2>/dev/null || go env GOBIN)/k8s-pod-oom-oracle"
